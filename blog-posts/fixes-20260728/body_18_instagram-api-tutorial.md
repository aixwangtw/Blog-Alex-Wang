...
這支教學的 [Threads 貼文](https://www.threads.com/@alex_wang.ai/post/DYpIU-RD3kr)累積了 18,000+ 觀看、456 次分享、42 次轉發——下面的 FAQ 有一部分就是從留言區的真實提問整理出來的。

## 開始前先準備好

1. **FB 帳號**：登入 Meta 開發者後台用（[帳號注意事項](/blog/meta-api-application/)）
...
- [自動發文與權限設定](/blog/auto-posting-permissions/)：頻率像真人、權限只拿需要的
