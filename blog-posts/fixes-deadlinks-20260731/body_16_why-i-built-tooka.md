...
4. 透過 Meta 官方 API 一鍵發佈到 [IG](/blog/instagram-api-tutorial/) / FB / [Threads](/blog/threads-api-tutorial/)

不想安裝或 clone repo，可以直接開啟 [Tooka 線上版](https://tooka.js0980420.workers.dev/) 在瀏覽器使用。

需要自行部署、修改模板或查看完整原始碼，可以前往 [GitHub：js0980420/tooka](https://github.com/js0980420/tooka)。

## 怎麼開始？

- **會用 AI Agent 的人**：直接 clone repo 照 README 走
- **還不會 AI Agent**：約我的[一對一教學](/services/one-on-one/)，從安裝到做出自己的圖文流程一次帶完